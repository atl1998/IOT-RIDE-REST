...
public class MapaActividadCliente extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private MaterialButton  btnVolver, btnMostrarQr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Botón Mostrar QR
        btnMostrarQr.setOnClickListener(v -> {
            Intent i = new Intent(MapaActividadCliente.this, QrClienteActivity.class);
        ...
        // Listener en tiempo real: ubicación y estado
        DocumentReference ref = db.collection("servicios_taxi").document(serviceId);
        serviceListener = ref.addSnapshotListener((snap, e) -> {
            ...
            runOnUiThread(() -> {
                // Crear o mover marcador del taxi
                if (mTaxiMarker == null) {
                ...
                // Si ya está en curso, trazar la ruta cliente→destino

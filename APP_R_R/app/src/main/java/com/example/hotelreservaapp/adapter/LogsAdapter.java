...
public class LogsAdapter extends RecyclerView.Adapter<LogsAdapter.LogViewHolder> {
    ...
    public void onBindViewHolder(@NonNull LogViewHolder holder, int position) {
        ...
        } else if (accion.toLowerCase().contains("eliminado") || accion.toLowerCase().contains("cancelado")|| accion.toLowerCase().contains("rechazo")) {
        ...
        } else if (accion.toLowerCase().contains("check-out") || accion.toLowerCase().contains("aprobación")|| accion.toLowerCase().contains("iniciado")) {

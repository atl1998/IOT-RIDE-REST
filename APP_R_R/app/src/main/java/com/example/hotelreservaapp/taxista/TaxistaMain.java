...
import com.example.hotelreservaapp.taxista.fragments.TaxiHistorialFragment;
...
public class TaxistaMain extends AppCompatActivity {
    ...
    private final BottomNavigationView.OnItemSelectedListener navListener =
            item -> {
                ...
                } else if (itemId == R.id.historialTaxista) {
                    selectedFragment = new TaxiHistorialFragment();
